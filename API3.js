fetch('https://api.jikan.moe/v4/manga?order_by=scored_by&genres=14&sort=desc&sfw=true', {
    method: "GET",
})
...
.then((data)=>{
    ...
    thing.map((data)=>{
        ...
        const comicContainer = document.getElementById("horrorStuff");
...
fetch('https://api.jikan.moe/v4/manga?order_by=scored_by&genres=10&sort=desc&sfw=true', {
    method: "GET",
})
.then((response)=>response.json())
.then((data)=>{
    ...
    thing.map((data)=>{
        ...
        const rating0 = data.score;
        const id0 = data.mal_id;
        const comicContainer = document.getElementById("fantasyStuff");
...
fetch('https://api.jikan.moe/v4/manga?order_by=scored_by&genres=24&sort=desc&sfw=true', {
    method: "GET",
})
.then((response)=>response.json())
.then((data)=>{
    ...
    thing.map((data)=>{
        ...
        const rating0 = data.score;
        const id0 = data.mal_id;
        const comicContainer = document.getElementById("scifiStuff");
